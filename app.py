...
/* Заголовки и текст в боковой панели */
...
/* ================================
   3. ЦИФРА НАД ПОЛЗУНКОМ (ФИРМЕННЫЙ ОРАНЖЕВЫЙ)
================================ */
...
/* Поддержка разных версий Streamlit */
section[data-testid="stSidebar"] div[data-testid="stSlider"] div[data-testid="stThumbValue"] span {
    color: #FF4C24 !important;
    -webkit-text-fill-color: #FF4C24 !important;
}
...
/* ================================
   5. ПОЛЯ ВВОДА И ВЫПАДАЮЩИЕ СПИСКИ
================================ */
